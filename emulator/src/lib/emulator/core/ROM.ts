...
class ROM {
  ...
  public nbrPRGBanks: number;
  public nbrCHRBanks: number;
  public mapperType: number;
  public mirrorType: number;
  public region: number;
  public prg: Uint8Array;
  public chr: Uint8Array;
  public mapper: NROM | MMC1 | UXROM | CNROM | MMC3;

  constructor(dataBuffer: number) {
    let p = 0;
    ...
    const prgLength = this.nbrPRGBanks * PRG_BANK_SIZE;
    const chrLength = this.nbrCHRBanks * CHR_BANK_SIZE;
