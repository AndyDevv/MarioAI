...
class Console extends Notifier {
  ...
  public quickSaveData: any;
  public frameReq: number;
  public frameThrottling: Throttle;
  public nesThrottling: Throttle;
  public frameNbr: number;
  public opCodesKeys: string[];
  public modeKeys: string[];
  public _tick: any;
  ...
  quickSave() {
    ...
    const quickSaveData = JSON.parse(JSON.stringify(this.cpu));
  ...
  start() {
    ...
    this.frameReq = window.requestAnimationFrame(this.frame.bind(this));
  }
